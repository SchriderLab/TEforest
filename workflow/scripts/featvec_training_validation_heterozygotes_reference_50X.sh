...
#validate
python $validation_script -n $validation_folder/condense.npz -m /nas/longleaf/home/adaigle/work/test_TEforest/basenorm_feats_50X/2L2R_reference/svrf_all.pkl -o $training_folder
python $validation_script -n $training_folder/condense.npz -m /nas/longleaf/home/adaigle/work/test_TEforest/basenorm_feats_50X/3L3RX_reference/svrf_all.pkl -o $validation_folder
