...
#plt_dir <- "/nas/longleaf/home/adaigle/work/test_TEforest/basenorm_feats_5X/2L_2R_plots"
...
truth_nonreference_extend_gr <- extend(subsetByOverlaps(truth_gr, ISO1_og_gr, type=c("equal"), invert=TRUE, ignore.strand=TRUE), 50, 50)
