...
#result_path <- paste0("/nas/longleaf/home/adaigle/work/mcclintock_stuff/trimmed_reads/", genome, "_1/results/")
...
#moving files
source_file <- paste0(basedir_outputs_path, "/output/", genome1, "_", genome2, "_TEforest_nonredundant.bed")
# Specify the destination directory
destination_folder <- paste0("/nas/longleaf/home/adaigle/work/mcclintock_stuff/trimmed_reads/", genome, "_1/results/", caller_name)
...
source_file <- paste0(basedir_outputs_path, "/output/", genome1, "_", genome2, "_TEforest_bps_nonredundant.bed")
# Specify the destination directory
destination_folder <- paste0("/nas/longleaf/home/adaigle/work/mcclintock_stuff/trimmed_reads/", genome, "_1/results/", caller_name, "_bps")
if (!dir.exists(destination_folder)) {
  # Create the directory
  dir.create(destination_folder)
}
...
ggsave(paste0(plt_dir, "/performance_plots/", genome1, "_", genome2,"UPDATED", ".pdf"), p, width=14)
