...
load("/nas/longleaf/home/adaigle/TEforest/workflow/scripts/benchmark_mapping_results_150_50X_revision.RData")

#load("/nas/longleaf/home/adaigle/work/test_TEforest/test_lightgbm_50X_newfilter_dynamiclength/2L_2R_plots/JUT-008_MUN-009.RData")
classification_df <- read.csv("/nas/longleaf/home/adaigle/work/test_TEforest/test_lightgbm_50X_newfilter_dynamiclength/3L3RX_classifer/JUT-008_MUN-009.csv")
...
benchmark_mapping_results_TEforest <- benchmark_mapping_results %>% 
    filter(caller=="TEforest_classifier_filter_bps")
...
false_negatives %>% filter(TE=="Kepler")
...
write.csv(TEfam_performance_df, "/nas/longleaf/home/adaigle/TEforest/revised_plots/TEfam_perf_df.csv", row.names = FALSE)
...
benchmark_mapping_results_all <- benchmark_mapping_results %>% 
        filter(caller %in% c("TEforest_classifier_filter_bps", "popoolationte", "retroseq", "teflon", "temp", "temp2"))
...
missing_fn_nogenome <- missing_fn %>% select(seqnames, start, end, TE, caller) %>% unique()

all_fn <- rbind(missing_fn_nogenome, allcallers_fn_df)
...
suppfig <- ggarrange(unique_tp_upset, unique_fp_upset, 
                    labels = c("A", "B"),
                    font.label = list(size = 22, color = "black", face = "bold", family = NULL),
                    ncol = 1, nrow = 2)


ggsave("/nas/longleaf/home/adaigle/TEforest/revised_plots/upset.svg", plot = length_upset_fig, width = 8.5, height = 10, dpi = 300)
ggsave("/nas/longleaf/home/adaigle/TEforest/revised_plots/upset.jpg", plot = length_upset_fig, width = 8.5, height = 10, dpi = 300)
ggsave("/nas/longleaf/home/adaigle/TEforest/revised_plots/upset.tiff", plot = length_upset_fig, width = 8.5, height = 10, dpi = 300)

ggsave("/nas/longleaf/home/adaigle/TEforest/revised_plots/TEratio.svg", plot = TEratio_comparision, width = 8.5, height = 5, dpi = 300)
ggsave("/nas/longleaf/home/adaigle/TEforest/revised_plots/TEratio.jpg", plot = TEratio_comparision, width = 8.5, height = 5, dpi = 300)
ggsave("/nas/longleaf/home/adaigle/TEforest/revised_plots/TEratio.tiff", plot = TEratio_comparision, width = 8.5, height = 5, dpi = 300)

ggsave("/nas/longleaf/home/adaigle/TEforest/revised_plots/upset_tpfn.svg", plot = suppfig, width = 8.5, height = 10, dpi = 300)
ggsave("/nas/longleaf/home/adaigle/TEforest/revised_plots/upset_tpfn.jpg", plot = suppfig, width = 8.5, height = 10, dpi = 300)
ggsave("/nas/longleaf/home/adaigle/TEforest/revised_plots/upset_tpfn.tiff", plot = suppfig, width = 8.5, height = 10, dpi = 300)
