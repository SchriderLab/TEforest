...
#
samtools cat -o combined_2R3R_genome1.bam 2R_reads_genome1.bam 3R_reads_genome1.bam
...
samtools cat -o combined_2R3R_genome2.bam 2R_reads_genome2.bam 3R_reads_genome2.bam
